...
def russkie_dates(dick):
        '''Русифицирует даты'''
        datelist = ['ДАТА РЕГИСТРАЦИИ','ДАТА ПОСЛЕДНЕЙ ОПЕРАЦИИ','ДАТА ПИСЬМА ПО РЕЕСТРУ','ДАТА ЗАПРОСА ПО РЕЕСТРУ','ДАТА ПРЕДПИСАНИЯ ПО РЕЕСТРУ','ДАТА ПРОВЕДЕНИЯ ГОСА','ДАТА ЗАПРОСА ПО ГОСА','ДАТА ПРОВЕРКИ ГОСА','ДАТА ПРЕДПИСАНИЯ ПО 1 ВЫПУСКУ','ДАТА ОПРЕДЕЛЕНИЯ СТАТУСА','ДАТА РЕШЕНИЯ ОБ ОСВОБОЖДЕНИИ','ДАТА ОТКАЗА В ОСВОБОЖДЕНИИ ОТ РАСКРЫТИЯ','ДАТА ПРОВЕРКИ','ДАТА ЗАПРОСА ПО НЕ РАСКРЫТИЮ ИНФОРМАЦИИ','ДАТА ПРЕДПИСАНИЯ ПО НЕ РАСКРЫТИЮ ИНФОРМАЦИИ','ДАТА ЗАПРОСА О РЕЗУЛЬТАТАХ ПРОВЕДЕНИЯ ТОРГОВ В ОБЩЕСТВЕ','ДАТА ОТВЕТА НА ЗАПРОСА О РЕЗУЛЬТАТАХ ПРОВЕДЕНИЯ ТОРГОВ В ОБЩЕСТВЕ','ДАТА ЗАКЛЮЧЕНИЯ ЮРИСТАМ','ДАТА ПРОТОКОЛА','ДАТА ПОСТАНОВЛЕНИЯ','ДАТА ПИСЬМА В ФНС','ВЗАИМОДЕЙСТВИЕ С ФНС НА ЕЖЕКВАРТАЛЬНОЙ ОСНОВЕ (ДАТА ПИСЬМА)','ДАТА ВНЕСЕНИЯ ЗАПИСИ']
